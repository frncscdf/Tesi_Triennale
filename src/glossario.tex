...
\newglossaryentry{depinjg}
{
    ...
    description={In ingegneria del software è una tecnica nella quale un oggetto si occupa di fornire tuttle le dipendenze necessarie ad un altro oggetto. Viene utilizzato per semplificare l'attività di \textit{test} sul \textit{software}}
}
